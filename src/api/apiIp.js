...
export const interfaceIp = `${protocol}//${projectAddrass}/zzx`;
// //LOGO图片的请求地址
// export const logoImgAddress = `${protocol}//${projectAddrassNoPort}`;
//对外提供的服务地址
export const publicIp = process.env.NODE_ENV === 'development' ? 'http://api.profsearch.ai' : interfaceIp;
// export const logoImgIp = process.env.NODE_ENV === 'development' ? 'http://127.0.0.1' :
// logoImgAddress;

//当前只有这个ip地址有用 10 July 2019
// export const publicIp = 'http://43.240.97.130:8080';