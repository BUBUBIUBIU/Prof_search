...
class UpdatePostDoc extends Component {
    constructor(props) {
        super(props);
        this.state = this.props.currentPostDoc;
    }
    ...
    render(){
        ...
        // console.log('In UpdatePostDoc:', this.state);
        return(
            <div>
...
export default withStyles(styles)(UpdatePostDoc);
