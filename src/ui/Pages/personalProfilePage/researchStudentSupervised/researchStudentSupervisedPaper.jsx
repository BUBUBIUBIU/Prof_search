 ...
 * @author Shaochuan L(clu3842@gmail.com)
 * @description    
 */
...
class researchStudentSupervisedPaper extends Component {
    constructor(props) {
        console.log(123);
        super(props);
        this.state = {
...
export default withStyles(styles)(researchStudentSupervisedPaper);