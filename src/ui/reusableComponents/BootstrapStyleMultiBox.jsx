...
class BootStrapStyleMultiBox extends Component{
    constructor(props){
        super(props);
        this.state = {
            input: '',
        ...
        <div >
            ...
            <Paper className={classes.root} elevation={0}>
                    <InputBase placeholder={this.props.placeHolder} className={classes.input}
                        onChange={this.onChangeInput} value = {this.state.value} multiline="true" rows="4"/>
                    {/* <TextField
                    className={classes.textField}
                    onChange={this.onChangeInput} value = {this.state.value} multiline rows="4"
                /> */}
            </Paper>
        </div>
        );
...
export default injectIntl(withStyles(styles)(BootStrapStyleMultiBox));   